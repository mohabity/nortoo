        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-sm border border-border bg-white px-3 py-2 text-sm text-ink-1 focus:outline-none focus:ring-2 focus:ring-sun/50"
      ...
      <Card className="border-coral/30">
        <CardHeader>
          <div className="flex items-center gap-2">
            ...
            <div>
              <CardTitle className="text-base text-coral">
                Zone de danger
              </CardTitle>
              <CardDescription>
